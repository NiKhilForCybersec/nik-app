...
const ErrandsScreen = ({ onNav }) => {
  const [view, setView] = React.useState('list');
  const [items, setItems] = React.useState(ERRANDS.list);
  ...
  return (
    <div style={{ padding: '8px 16px 100px' }}>
      <div style={{ marginBottom: 16 }}>
        ...
        <div className="display" style={{ fontSize: 28, fontWeight: 'var(--display-weight, 500)', lineHeight: 1.1, marginTop: 4, textTransform: 'var(--display-case)', letterSpacing: 'var(--display-tracking)' }}>Errands</div>
      </div>
      ...
      <div className="glass fade-up" style={{ padding: 14, marginBottom: 12, background: 'oklch(0.78 0.16 var(--hue) / 0.06)', position: 'relative', overflow: 'hidden' }}>
        <div style={{ display: 'flex', alignItems: 'baseline', justifyContent: 'space-between', marginBottom: 10 }}>
          <div style={{ fontSize: 10, color: 'var(--fg-3)', fontFamily: 'var(--font-mono)', letterSpacing: 1.5 }}>AETHER ROUTED IT</div>
...
Object.assign(window, { ErrandsScreen });
