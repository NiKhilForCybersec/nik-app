...
const VaultScreen = ({ onNav }) => {
  const [view, setView] = React.useState('collections');
  ...
  return (
    <div style={{ padding: '8px 16px 100px' }}>
      <div style={{ marginBottom: 16 }}>
        ...
        <div className="display" style={{ fontSize: 28, fontWeight: 'var(--display-weight, 500)', lineHeight: 1.1, marginTop: 4, textTransform: 'var(--display-case)', letterSpacing: 'var(--display-tracking)' }}>Memory Vault</div>
      </div>
      ...
      <div style={{ display: 'flex', gap: 4, marginBottom: 12, padding: 3, background: 'var(--input-bg)', borderRadius: 12 }}>
        {[['collections','Collections'],['recent','Recent'],['places','Places']].map(([k,l]) => (
