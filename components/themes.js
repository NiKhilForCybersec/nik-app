...
const applyTheme = (themeId) => {
  ...
  r.style.setProperty('--display-weight', t.fonts.displayWeight);
...
window.getTheme = (themeId) => THEMES[themeId] || THEMES['solo-leveling'];
window.getThemeVocab = (themeId) => (THEMES[themeId] || THEMES['solo-leveling']).vocab;
