...
function canView(viewerId, ownerId, category, sharing = DEFAULT_SHARING) {
  ...
  return TRUST_TIERS[tier]?.cats?.includes(category);
}

window.CIRCLE_MEMBERS = CIRCLE_MEMBERS;
window.PRIVACY_CATEGORIES = PRIVACY_CATEGORIES;
window.TRUST_TIERS = TRUST_TIERS;
window.DEFAULT_SHARING = DEFAULT_SHARING;
window.VIEW_LOG = VIEW_LOG;
window.CIRCLE_ALERTS = CIRCLE_ALERTS;
window.canCircleView = canView;
